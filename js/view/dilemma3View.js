var Dilemma3View = function (model, container) {
  ...
  this.update = function(args){
    if ( args == "dilemma2Done"){
      ...
      var houseA1 = model.getHouses(2, 0, 0);
      var houseA2 = model.getHouses(2, 0, 1);
      var houseA3 = model.getHouses(2, 0, 2);
      var houseA4 = model.getHouses(2, 0, 3);
      var houseA5 = model.getHouses(2, 0, 4);
      var houseA6 = model.getHouses(2, 0, 5);

      var houseB1 = model.getHouses(2, 1, 0);
      var houseB2 = model.getHouses(2, 1, 1);
      var houseB3 = model.getHouses(2, 1, 2);
