var InstructionsView = function (model, container){
  ...
  var p1 = $("<p>In het volgende deel van dit experiment krijgt u 20 keuzedilemma's voorgeschoteld. U krijgt telkens van twee huizen de details te zien met betrekking tot prijs, woningtype, woonoppervlak, aantal slaapkamers, bebouwing van de omgeving en afstand tot een basisschool. Kies steeds het huis welke het best bij uw voorkeuren past. U kunt een keuze maken tussen beide huisprofielen door één van beide bolletjes onder de huizen te selecteren. U kunt ook aangeven geen voorkeur te hebben. Ten slotte kunt u uw keuze bevestigen door op 'Volgende' te klikken. Op deze pagina kunt u nog geen voorkeur invoeren. De getoonde prijs is een indicatie, die kan verschillen op basis van de exacte locatie van het huis. Het kan bij het maken van de afweging dus handig zijn om op het verschil tussen beide huizen te letten.</p>");
