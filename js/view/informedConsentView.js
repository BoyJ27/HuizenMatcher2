var InformedConsentView = function(model, container){
	...
	var p = $("<p>Welkom bij de HuizenMatcher! Met deze tool kunt u op zoek naar het ideale huis in de omgeving van uw voorkeur. Aan de hand van enkele dilemma's berekenen we uw huizenprofiel en zoeken we de beste match voor uw wensen. Om de effectiviteit van de tool te testen, stellen we u na afloop nog enkele vragen en slaan we uw antwoorden op de vragen op. Alle informatie wordt alleen gebruikt voor onderzoek en wordt anoniem en confidentieel bewaard.* Deelname heeft geen risico’s en duurt ongeveer 10 minuten. Tijdens je deelname kun je op elk moment en om elke reden stoppen door de browser te sluiten.</p>");
