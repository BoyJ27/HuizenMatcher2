var Dilemma4View = function (model, container) {
  ...
  this.update = function(args){
    if ( args == "dilemma3Done"){
      ...
      var houseA1 = model.getHouses(3, 0, 0);
      var houseA2 = model.getHouses(3, 0, 1);
      var houseA3 = model.getHouses(3, 0, 2);
      var houseA4 = model.getHouses(3, 0, 3);
      var houseA5 = model.getHouses(3, 0, 4);
      var houseA6 = model.getHouses(3, 0, 5);

      var houseB1 = model.getHouses(3, 1, 0);
      var houseB2 = model.getHouses(3, 1, 1);
      var houseB3 = model.getHouses(3, 1, 2);
      var houseB4 = model.getHouses(3, 1, 3);
      var houseB5 = model.getHouses(3, 1, 4);
      var houseB6 = model.getHouses(3, 1, 5);
      ...
      var table = $( "<table class='case' id='case4'></table>"); // The whole table
